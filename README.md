...
2. Autorisez, si nécessaire, l’installation depuis cette source.
   ...
   - Sur S21, *Appli non sécurisée bloquée* => *Plus de détails* => *Installer quand même* :
    <img width="108" height="217" alt="image" src="https://github.com/user-attachments/assets/9f4a7e24-490a-43fb-87d3-9fe864e7eb99" />
<img width="108" height="217" alt="image" src="https://github.com/user-attachments/assets/56db99b9-11e2-4277-8a86-732db3b11f0f" />
